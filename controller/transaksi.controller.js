...
const telurModel = require(`../model/telur.model`)
...
const detailModel = require(`../model/detail.transaksi.model`)

const packModel = require(`../model/pack.model`)

const { request, response } = require("../route/transaksi.route")
...
exports.showFormTransaksi = async (request, response) => {
    try {
        ...
        return response.render(`../view/index`, sendData)
    } catch (error) {
        let sendData = {
            message: error
        }
